(function() {
    ...
    Suggestions = (function() {
        ...
        Suggestions.prototype.showAt = function(position) {
            ...
            if (position.y + height > $(window).height()) {
                return this.element.css({top: position.y - this.element.outerHeight() - 25})
            }
        };
    ...
    CodeCompletion = (function() {
        ...
        CodeCompletion.prototype.autoQuote = function(event, ch, open, close) {
            ...
            nextChar = this.editor.getRange(cursor, {line: cursor.line,ch: cursor.ch + 1});
        ...
        CodeCompletion.prototype.keypress = function(e) {
            switch (e.charCode) {
                ...
                case 39:
                    ...
                    break;
                case 8216:
                    return this.autoQuote(e, "Åe", "Åe", "Åf");
                case 8217:
                    return this.ignoreBracketIfClosed(e, "Åf");
                case 8220:
                    return this.autoQuote(e, "Åg", "Åg", "Åh");
                case 8221:
                    return this.ignoreBracketIfClosed(e, "Åh");
                case 40:
                    return this.autoQuote(e, "(", "(", ")");
                case 41:
                    return this.ignoreBracketIfClosed(e, ")");
